;; 1. Based on: run101
;; 2. Description: Arctigenin to AA + AG, IG
;; x1. Author: user
...
; Xpose
$TABLE ID TIME DV MDV CMT DL IPRED IWRES ONEHEADER NOPRINT FILE=sdtab105.tab
$TABLE ID K10 K20 K30 V1 Fi1 Fi2 ONEHEADER NOPRINT FILE=patab105.tab
