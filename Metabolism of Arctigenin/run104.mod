;; 1. Based on: run101
;; 2. Description: Arctigenin to AA + AG, IV, time delay to Liver
;; x1. Author: user
...
; Xpose
$TABLE ID TIME DV MDV CMT DL IPRED IWRES ONEHEADER NOPRINT FILE=sdtab104.tab
$TABLE ID K10 K20 K30 V1 Fi1 Fi2 ETA1 ETA2 ETA3 ETA4 ETA5 ETA6 ONEHEADER NOPRINT FILE=patab104.tab
