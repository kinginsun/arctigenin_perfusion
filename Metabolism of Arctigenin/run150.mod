...
$SIGMA
 0.00729 ; Residual error

$EST METHOD=0 MAXEVAL=99 NOABORT SIG=5 PRINT=1
$COV

; Xpose
$TABLE ID TIME DV MDV CMT DL ONEHEADER NOPRINT FILE=sdtab150.tab
$TABLE ID Ka K20 K30 V2 ONEHEADER NOPRINT FILE=patab150.tab
