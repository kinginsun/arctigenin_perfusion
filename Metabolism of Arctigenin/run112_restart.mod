;; 1. Based on: run109
;; 2. Description: Arctigenin to AA + AG, IG, mean Cl 2, 4.8 mg
;; x1. Author: user
...
; Xpose
$TABLE ID TIME DV MDV CMT DL ONEHEADER NOPRINT FILE=sdtab112.tab
$TABLE ID Ka K20 K30 V2 ONEHEADER NOPRINT FILE=patab112.tab
