;; 1. Based on: run101
;; 2. Description: Arctigenin to AA + AG, IV, no Liver transfer, add other metabolites
;; x1. Author: user
...
$ERROR
IPRED = F
W = SQRT(THETA(11)**2*IPRED**2 + THETA(12)**2)
Y = IPRED + W*EPS(1)
IRES = DV-IPRED
IWRES = IRES/W
...
; Xpose
$TABLE ID TIME DV MDV CMT DL IPRED IWRES ONEHEADER NOPRINT FILE=sdtab103.tab
$TABLE ID K10 K20 K30 V1 Fi1 Fi2 ETA1 ETA2 ETA3 ETA4 ETA5 ETA6 ONEHEADER NOPRINT FILE=patab103.tab
