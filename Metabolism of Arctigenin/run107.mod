;; 1. Based on: run101
;; 2. Description: Arctigenin to AA + AG, IV, no Liver transfer
;; x1. Author: user
...
$SIGMA
 0.0315 ; Residual error

$EST METHOD=0 MAXEVAL=999 NOABORT SIG=5 PRINT=1 POSTHOC
$COV

; Xpose
$TABLE ID TIME DV MDV CMT DL IPRED IWRES ONEHEADER NOPRINT FILE=sdtab107.tab
$TABLE ID K10 K20 K30 V1 Fi1 Fi2 ONEHEADER NOPRINT FILE=patab107.tab
