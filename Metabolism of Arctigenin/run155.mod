...
$EST METHOD=0 MAXEVAL=999 NOABORT SIG=8 PRINT=1
$COV

; Xpose
$TABLE ID TIME DV MDV CMT DL RTE ONEHEADER NOPRINT FILE=sdtab155.tab
$TABLE ID Ka K20 K30 V2 ONEHEADER NOPRINT FILE=patab155.tab
